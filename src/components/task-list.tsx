      ...
      switch (sortField) {
        ...
        case "dueDate":
          if (!a.dueDate && !b.dueDate) comparison = 0;
            ...
            comparison =
              (typeOrder[a.dueDate.type] || 0) -
              (typeOrder[b.dueDate.type] || 0);

            // If same type, compare by value
            if (comparison === 0) {
              if (a.dueDate.type === "date" && b.dueDate.type === "date") {
                comparison =
                  new Date(a.dueDate.value as string).getTime() -
                  new Date(b.dueDate.value as string).getTime();
              } else {
                    ...
                    <div className="border-t bg-muted/50 p-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground">
                          No sub-tasks available in this demo.
                        </p>
                      </div>
                    </div>
                  )}
